...
export class ProjectsComponent implements OnInit {
    ...
    public projectCardClicked(projectName: string): void {
        ...
        } else if (projectName === "ipoc") {
            alert("IPOC isn't currently on Github, but check back soon!");
        } else if (projectName === "screeps") {
            window.open("https://github.com/BenTaylorPublic/screeps", "_blank");
        }
    }
